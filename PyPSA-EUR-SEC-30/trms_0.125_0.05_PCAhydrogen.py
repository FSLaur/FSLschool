...
# PCA
eigen_values1998, eigen_vectors1998, Cov_mat1998, c1998, variance_explained1998, VT1998, X_norm1998 = PCA(H21998,NAMES)
eigen_values1999, eigen_vectors1999, Cov_mat1999, c1999, variance_explained1999, VT1999, X_norm1999 = PCA(H21999,NAMES)
eigen_values2000, eigen_vectors2000, Cov_mat2000, c2000, variance_explained2000, VT2000, X_norm2000 = PCA(H22000,NAMES)
eigen_values1987, eigen_vectors1987, Cov_mat1987, c1987, variance_explained1987, VT1987, X_norm1987 = PCA(H21987,NAMES)
eigen_values2013, eigen_vectors2013, Cov_mat2013, c2013, variance_explained2013, VT2013, X_norm2013 = PCA(H22013,NAMES)
eigen_values2014, eigen_vectors2014, Cov_mat2014, c2014, variance_explained2014, VT2014, X_norm2014 = PCA(H22014,NAMES)
...
VT1998[[2]] = -1*VT1998[[2]]
VT1999[[1]] = -1*VT1999[[1]]
VT2000[[0,1]] = -1*VT2000[[0,1]] 
VT1987[[0,1,3]] = -1*VT1987[[0,1,3]] 
# VT2013[[2,3]] = -1*VT2013[[2,3]]
VT2014[[1,3]] = -1*VT2014[[1,3]]
...
# Area1998a, idx1998a, MaxArea1998a, a_kday1998a = AmplitudeAreaPC1PC2(a_k1998df) # 1998
# Area1999a, idx1999a, MaxArea1999a, a_kday1999a = AmplitudeAreaPC1PC2(a_k1999df) # 1999
# Area2000a, idx2000a, MaxArea2000a, a_kday2000a = AmplitudeAreaPC1PC2(a_k2000df) # 2000
# Area1987a, idx1987a, MaxArea1987a, a_kday1987a = AmplitudeAreaPC1PC2(a_k1987df) # 1987
# Area2013a, idx2013a, MaxArea2013a, a_kday2013a = AmplitudeAreaPC1PC2(a_k2013df) # 2013
# Area2014a, idx2014a, MaxArea2014a, a_kday2014a = AmplitudeAreaPC1PC2(a_k2014df) # 2014
# Ratio of area above or below
# Area1998R = Area1998['AreaStep'].sum()/Area1998a['AreaStep'].sum()
# Area1999R = Area1999['AreaStep'].sum()/Area1999a['AreaStep'].sum()
# Area2000R = Area2000['AreaStep'].sum()/Area2000a['AreaStep'].sum()
# Area1987R = Area1987['AreaStep'].sum()/Area1987a['AreaStep'].sum()
# Area2013R = Area2013['AreaStep'].sum()/Area2013a['AreaStep'].sum()
# Area2014R = Area2014['AreaStep'].sum()/Area2014a['AreaStep'].sum()
...
ax.set_title('Amplitude Area PC1:'+' '+constraint3,fontsize = 20, weight = 'bold') #OBS check columns
ax2=ax.twinx()
...
savefigure1('System', constraint3, 'FFTh2'+'1998', fig)
fig = FFT_plot(a_k1999df,constraint3,'1999') # 1999
savefigure1('System', constraint3, 'FFTh2'+'1999', fig)
fig = FFT_plot(a_k2000df,constraint3,'2000') # 2000
savefigure1('System', constraint3, 'FFTh2'+'2000', fig)
fig = FFT_plot(a_k1987df,constraint3,'1987') # 1987
savefigure1('System', constraint3, 'FFTh2'+'1987', fig)
fig = FFT_plot(a_k2013df,constraint3,'2013') # 2013
savefigure1('System', constraint3, 'FFTh2'+'2013', fig)
fig = FFT_plot(a_k2014df,constraint3,'2014') # 2014
savefigure1('System', constraint3, 'FFTh2'+'2014', fig)
#%% PCA bar plot
# remember to change
...
fig.tight_layout()
savefigure1('System', constraint3, 'hydrogenPCAploth2', fig)
#%%
